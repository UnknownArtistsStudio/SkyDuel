...
- A low, early-computer cockpit voice privately warns the affected pilot: **BOMB HATCH OPEN**, **MISSILE ARMED**, **PARACHUTE EQUIPPED**, **EJECT EJECT**, and **MAYDAY MAYDAY** at critical damage in three-hit mode.
...
- Every pilot receives one missile at each personal three-kill milestone: 3, 6, 9, 12, and so on. Unused missiles accumulate. Press **B** to use one (before a carried bomb): the tiny missile falls away from the aircraft for a visible beat, then ignites and races straight ahead. Its smoke is a trail of individual fading pixels. The delayed ignition must be allowed for when aiming, and a well-timed barrel roll can dodge it.
- With revenge pilots enabled, the fifth total kill releases one parachute pickup. Its collector gets one armed ejection the next time another player shoots the aircraft down. The tiny pilot can steer while falling, run after landing, and fire a weaker rapid machine gun upward; six hits equal one aircraft-damage hit. Aircraft fire can blow the pilot apart, bombs throw the body upward, and missiles vaporize it.
- Choose the stepped **Tower**, **Sea**, or **Mountains** landscape. A sea crash leaves the pilot firing from the wreck, swimming pilots move slowly, and mountain peaks form dangerous collision surfaces and sheltered valleys. Aircraft and their speech bubbles disappear while inside the slowly drifting clouds, including one oversized cloud built for surprise exits.
- Draw an 8×8 pilot face in the setup screen. The pixel portraits introduce pilots as they enter and return for the winner display.
...
Room creators choose one- or three-hit aircraft, Tower/Sea/Mountains, revenge pilots on or off, and bomb pickups on or off. When bombs are enabled, one bomb power-up appears in a slowly drifting cloud at a time; another returns after the previous one is collected.
