...
test("keeps the original-style flight, pixel display, and multiplayer promises", async () => {
  ...
  assert.match(component, /label="CPU PLAYERS"/);
  ...
  assert.match(component, /label="DAMAGE"/);
  assert.match(component, /label="PARACHUTES"/);
  ...
  assert.match(component, /label="MAP"/);
  assert.match(component, /"mountains"/);
  assert.match(component, /landscape\.toUpperCase\(\)/);
  assert.match(component, /FREE FOR ALL/);
  assert.match(component, /KILLS TO WIN/);
  assert.match(component, /setBombsEnabled\(!bombsEnabled\)/);
  assert.match(component, /setParachuteMode\(!parachuteMode\)/);
  assert.match(component, /SetupChoiceButton/);
  assert.match(component, /Tap to change/);
  ...
  assert.match(component, /if \(screen === "playing"\) \{\s*playNewSounds/);
  assert.match(component, /gain\.gain\.value = 0/);
  assert.match(component, /active \? activeVolume : 0/);
